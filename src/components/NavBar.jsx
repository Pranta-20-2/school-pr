...
const NavBar = () => {
    return (
        <div className="navbar bg-base-100 shadow-lg px-4 fixed w-full z-10">
            <div className="flex-1">
                <a className="btn btn-ghost text-xl">SCHOOL-PR</a>
            </div>
            <div className="flex-none">
                <ul className="menu menu-horizontal px-1">
                    <Link to='/' className='font-bold pr-2'>Home</Link>
